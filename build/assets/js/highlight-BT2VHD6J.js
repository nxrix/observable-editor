...
async function getParser(language) {
  ...
  switch (language) {
    ...
    case "ts":
    case "jsx":
      return (await import("./dist-EOV544U5.js")).parser.configure({ dialect: language });
    case "python":
      return (await import("./dist-VSGG5QTW.js")).parser;
    case "html":
      return (await import("./dist-Q4T4WPMV.js")).parser;
    case "css":
      return (await import("./dist-XHCDXV6T.js")).parser;
    case "md":
      return (await import("./dist-WP2FVFDQ.js")).parser;
  }
}
